...
# --- CONFIG & STYLING ---
st.set_page_config(page_title="Stats Football", page_icon="⚽", layout="centered")
...
# --- APP UI ---
st.title("⚽ Stats Football")
st.subheader("2H Prediction Engine")

with st.expander("📝 Manual Match Input", expanded=True):
